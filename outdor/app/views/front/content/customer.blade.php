            ...
            <div class="col-md-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Detail Penyewa</h3>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p>(Contoh Tenda: {{ $car->make.' '.$car->model }})</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <table class="table">                       
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        {{ $diff->days.' Hari '.($diff->h > 0 ? $diff->h.' Hours' : '') }}
                                    </td>
